...
object StatusCode extends Enumeration {
   ...
   */
  val SESSION_PROGRESS = Value(183)
   ...
   * proxy the request.
   */
  val MULTIPLE_CHOICES = Value(300)
   ...
   */
  val MOVED_TEMPORARILY = Value(302)
   ...
   */
  val ALTERNATIVE_SERVICE = Value(380)
   ...
   */
  val PAYMENT_REQUIRED = Value(402)
   ...
   * authentication.
   */
  val PROXY_AUTHENTICATION_REQUIRED = Value(407)
   ...
   * @since v1.2
   */
  val CONDITIONAL_REQUEST_FAILED = Value(412)
   ...
   */
  val REQUEST_ENTITY_TOO_LARGE = Value(413)

  /**
   * The server is refusing to service the request because the Request-URI
   * is longer than the server is willing to interpret.
   */
  val REQUEST_URI_TOO_LONG = Value(414)
   ...
   * client.
   */
  val EXTENSION_REQUIRED = Value(421)
   ...
   */
  val INTERVAL_TOO_BRIEF = Value(423)
   ...
   */
  val ADDRESS_INCOMPLETE = Value(484)
   ...
   * an OPTIONS request.
   */
  val NOT_ACCEPTABLE_HERE = Value(488)
   ...
   */
  val SERVER_INTERNAL_ERROR = Value(500)
   ...
   */
  val SESSION_NOT_ACCEPTABLE = Value(606)
