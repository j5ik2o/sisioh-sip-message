...
import org.sisioh.sip.message.impl.{MessageContent, SIPRequestBuilder, SIPMessageSpecSupport, SIPMessage}
import scala.concurrent.ops._
import org.sisioh.sip.message.header.impl.{ViaList, Via, ContentLength, RequestLine}
  ...
  "test" in {
    ...
    using(TCPServerTransport(2002, Some(this))) {
      target =>
        ...
        val client = TCPTransport.connect(Peer("localhost", 2002), Some(this))
