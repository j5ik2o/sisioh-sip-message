...
class ViaListSpec extends Specification {
  "ViaList" should {
    ...
    "ただしいエンコード結果を取得できる" in {
      ...
      ViaList(List(via)).encodeByJson() must_== """{"headerNamne":"Via","parameters":[{"sentBy":{"host":"localhost"},"sentProtocol":{"protocolName":"SIP","protocolVersion":"2.0","transport":"TCP"},"parameters":{}}]}"""
      ViaList(List(via, via2)).encodeByJson() must_== """{"headerNamne":"Via","parameters":[{"sentBy":{"host":"localhost"},"sentProtocol":{"protocolName":"SIP","protocolVersion":"2.0","transport":"TCP"},"parameters":{}},{"sentBy":{"host":"localhost"},"sentProtocol":{"protocolName":"SIP","protocolVersion":"2.1","transport":"TCP"},"parameters":{}}]}"""
    }
