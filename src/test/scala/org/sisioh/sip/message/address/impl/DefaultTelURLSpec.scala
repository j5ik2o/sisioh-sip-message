  ...
  "DefaultTelURL" should {
    "電話番号のみの場合" in {
      ...
      "グローバルな電話番号としてのエンコード結果が得られる" in {
        ...
        target.encodeByJson() must_== """{"scheme":"tel","isGlobal":true,"phoneNumber":"09012345678","parameters":{"separator":";","values":{}}}"""
      }
    }
    "電話番号とパラメータを指定した場合" in {
      ...
      "グローバルなパラメータ付き電話番号としてのエンコード結果が得られる" in {
        ...
        target.encodeByJson() must_== """{"scheme":"tel","isGlobal":true,"phoneNumber":"09012345678","parameters":{"separator":";","values":{"PARAM1":"param1"}}}"""
      }
    }
    ...
    "プライベートな電話番号を指定した場合" in {
      ...
      "プライベートな電話番号としてのエンコード結果が得られる" in {
        ...
        target.encodeByJson() must_== """{"scheme":"tel","isGlobal":false,"phoneNumber":"4321","parameters":{"separator":";","values":{}}}"""
      }
    }
    "ポストダイアルを指定した場合" in {
      ...
      "ポストダイアル付き電話番号としてのエンコード結果が得られる" in {
        ...
        target.encodeByJson() must_== """{"scheme":"tel","isGlobal":false,"phoneNumber":"4321","parameters":{"separator":";","values":{"postd":"abc"}}}"""
      }
    }
    "ISDNサブアドレスを指定した場合" in {
      ...
      "ISDNサブアドレス付き電話番号としてのエンコード結果が得られる" in {
        ...
        target.encodeByJson() must_== """{"scheme":"tel","isGlobal":false,"phoneNumber":"4321","parameters":{"separator":";","values":{"isub":"0123"}}}"""
      }
    }
  }
}
